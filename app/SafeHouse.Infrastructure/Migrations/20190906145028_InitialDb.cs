        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Diner = table.Column<bool>(nullable: true),
                    Bath = table.Column<bool>(nullable: true),
                    LiecesRemoval = table.Column<bool>(nullable: true),
                    Clothes = table.Column<bool>(nullable: true),
                    VerballySocialCenter = table.Column<bool>(nullable: true),
                    VerballyEducation = table.Column<bool>(nullable: true),
                    VerballyCitizensAssociations = table.Column<bool>(nullable: true),
                    VerballyHealthInstitutions = table.Column<bool>(nullable: true),
                    VerballyPolice = table.Column<bool>(nullable: true),
                    VerballyOther = table.Column<bool>(nullable: true),
                    WrittenSocialCenter = table.Column<bool>(nullable: true),
                    WrittenEducation = table.Column<bool>(nullable: true),
                    WrittenCitizensAssociations = table.Column<bool>(nullable: true),
                    WrittenHealthInstitutions = table.Column<bool>(nullable: true),
                    WrittenPolice = table.Column<bool>(nullable: true),
                    WrittenOther = table.Column<bool>(nullable: true),
                    CbDecisionMakingSkills = table.Column<bool>(nullable: true),
                    CbProblemSolvingSkills = table.Column<bool>(nullable: true),
                    CbAssertiveCommunication = table.Column<bool>(nullable: true),
                    CbHowToSayNo = table.Column<bool>(nullable: true),
                    CbAwarenessOfYourself = table.Column<bool>(nullable: true),
                    CbRecognizingAndManagingEmotions = table.Column<bool>(nullable: true),
                    CbEmpathy = table.Column<bool>(nullable: true),
                    CbConfrontationWithStress = table.Column<bool>(nullable: true),
                    CbMaintainingPersonalHygiene = table.Column<bool>(nullable: true),
                    CbMaintainingHygieneOfClothingAndFootwear = table.Column<bool>(nullable: true),
                    CbHealth = table.Column<bool>(nullable: true),
                    CbPersonalSecurityAndCrisisManagementSituations = table.Column<bool>(nullable: true),
                    CbTakingCareOfPersonalFinances = table.Column<bool>(nullable: true),
                    CbMaintainingHygieneOfThePlaceOfResidence = table.Column<bool>(nullable: true),
                    CbUseOfHomeAppliances = table.Column<bool>(nullable: true),
                    CbMealPreparationAndServing = table.Column<bool>(nullable: true),
                    CbBehaviorAtTheTable = table.Column<bool>(nullable: true),
                    CbProcurementOfGroceries = table.Column<bool>(nullable: true),
                    CbHealthCareDuringPregnancy = table.Column<bool>(nullable: true),
                    CbPhysicalCareOfNewbornAndInfant = table.Column<bool>(nullable: true),
                    CbExpressingLoveForYourChild = table.Column<bool>(nullable: true),
                    CbChildProtection = table.Column<bool>(nullable: true),
                    CbStimulatingTheChild = table.Column<bool>(nullable: true),
                    CbIssuingCersonalDocuments = table.Column<bool>(nullable: true),
                    CbUseOfTheClock = table.Column<bool>(nullable: true),
                    CbTrafficRegulationsAndSigns = table.Column<bool>(nullable: true),
                    CbUtilizingCommunityResources = table.Column<bool>(nullable: true),
                    CbNavigatingTheSpace = table.Column<bool>(nullable: true),
                    CbUseOfMedia = table.Column<bool>(nullable: true),
                    CbActiveJobSearch = table.Column<bool>(nullable: true),
                    TxtDecisionMakingSkills = table.Column<string>(maxLength: 256, nullable: true),
                    TxtProblemSolvingSkills = table.Column<string>(maxLength: 256, nullable: true),
                    TxtAssertiveCommunication = table.Column<string>(maxLength: 256, nullable: true),
                    TxtHowToSayNo = table.Column<string>(maxLength: 256, nullable: true),
                    TxtAwarenessOfYourself = table.Column<string>(maxLength: 256, nullable: true),
                    TxtRecognizingAndManagingEmotions = table.Column<string>(maxLength: 256, nullable: true),
                    TxtEmpathy = table.Column<string>(maxLength: 256, nullable: true),
                    TxtConfrontationWithStress = table.Column<string>(maxLength: 256, nullable: true),
                    TxtMaintainingPersonalHygiene = table.Column<string>(maxLength: 256, nullable: true),
                    TxtMaintainingHygieneOfClothingAndFootwear = table.Column<string>(maxLength: 256, nullable: true),
                    TxtHealth = table.Column<string>(maxLength: 256, nullable: true),
                    TxtPersonalSecurityAndCrisisManagementSituations = table.Column<string>(maxLength: 256, nullable: true),
                    TxtTakingCareOfPersonalFinances = table.Column<string>(maxLength: 256, nullable: true),
                    TxtMaintainingHygieneOfThePlaceOfResidence = table.Column<string>(maxLength: 256, nullable: true),
                    TxtUseOfHomeAppliances = table.Column<string>(maxLength: 256, nullable: true),
                    TxtMealPreparationAndServing = table.Column<string>(maxLength: 256, nullable: true),
                    TxtBehaviorAtTheTable = table.Column<string>(maxLength: 256, nullable: true),
                    TxtProcurementOfGroceries = table.Column<string>(maxLength: 256, nullable: true),
                    TxtHealthCareDuringPregnancy = table.Column<string>(maxLength: 256, nullable: true),
                    TxtPhysicalCareOfNewbornAndInfant = table.Column<string>(maxLength: 256, nullable: true),
                    TxtExpressingLoveForYourChild = table.Column<string>(maxLength: 256, nullable: true),
                    TxtChildProtection = table.Column<string>(maxLength: 256, nullable: true),
                    TxtStimulatingTheChild = table.Column<string>(maxLength: 256, nullable: true),
                    TxtIssuingCersonalDocuments = table.Column<string>(maxLength: 256, nullable: true),
                    TxtUseOfTheClock = table.Column<string>(maxLength: 256, nullable: true),
                    TxtTrafficRegulationsAndSigns = table.Column<string>(maxLength: 256, nullable: true),
                    TxtUtilizingCommunityResources = table.Column<string>(maxLength: 256, nullable: true),
                    TxtNavigatingTheSpace = table.Column<string>(maxLength: 256, nullable: true),
                    TxtUseOfMedia = table.Column<string>(maxLength: 256, nullable: true),
                    TxtActiveJobSearch = table.Column<string>(maxLength: 256, nullable: true),
                    EdictiveWorkshops = table.Column<string>(maxLength: 256, nullable: true),
                    CreativeWorkshops = table.Column<string>(maxLength: 256, nullable: true),
                    Homework = table.Column<string>(maxLength: 256, nullable: true),
                    Training = table.Column<string>(maxLength: 256, nullable: true),
                    LearningSchoolMaterials = table.Column<string>(maxLength: 256, nullable: true),
                    InterventionsForTheDevelopmentOfCognitiveFunctions = table.Column<string>(maxLength: 256, nullable: true),
                    TelephoneContact = table.Column<string>(maxLength: 256, nullable: true),
                    PersonalContact = table.Column<string>(maxLength: 256, nullable: true),
                    InterventionAtTheSafeHouse = table.Column<string>(maxLength: 256, nullable: true),
                    Counseling = table.Column<string>(maxLength: 256, nullable: true),
